...
class Weather(Collector):
    ...
    def show(self):
        ...
        print("")
        print(
            "{}{}m{}{}".format(suffix, str(96), str(data["Low"]), tail),
            "{}{}m{}{}".format(suffix, str(99), str(data["Now"]), tail),
            "{}{}m{}{}".format(suffix, str(91), str(data["High"]), tail),
            "{}{}m{}{}".format(suffix, str(99), str(data["Rain ?"]), tail),
        )
        print("")
